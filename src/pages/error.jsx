  ...
  return (
    <div className="flex h-[calc(100vh-80px)] items-center justify-center p-5 bg-white w-full">
        <div className="text-center">
            ...
            <h1 className="mt-5 text-[36px] font-bold text-slate-800 lg:text-[50px]">Oops something went wrong</h1>
            <p className="text-slate-600 mt-5 lg:text-lg">Try to refresh this page or feel free to contact us if the problem presists</p>
        </div>
        </div>
  )
}
